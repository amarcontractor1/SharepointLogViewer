...
namespace LogViewer.CustomControls.Printing
{
    public class LogSetGridPaginator : DocumentPaginator
    {
        ...
        public LogSetGridPaginator(DataGrid documentSource, string documentTitle, Size pageSize, Thickness pageMargin)
        {
        ...
        {
            this.DocumentHeaderTextStyle = (Style)Application.Current.Resources.FindName("DocumentHeaderTextStyle");
            this.AlternatingRowBorderStyle = (Style)Application.Current.Resources.FindName("AlternatingRowBorderStyle");
            this.DocumentFooterTextStyle = (Style)Application.Current.Resources.FindName("DocumentFooterTextStyle");
            this.TableCellTextStyle = (Style)Application.Current.Resources.FindName("TableCellTextStyle");
            this.TableHeaderTextStyle = (Style)Application.Current.Resources.FindName("TableHeaderTextStyle");
            this.TableHeaderBorderStyle = (Style)Application.Current.Resources.FindName("TableHeaderBorderStyle");
            this.GridContainerStyle = (Style)Application.Current.Resources.FindName("GridContainerStyle");
        }
